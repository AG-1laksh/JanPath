    ...
    return (
        <div className="flex h-screen w-full overflow-hidden bg-[#F0F4F8] text-slate-800 font-sans">
            ...
            <main className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-8 bg-[#050505] text-white">
                <Header title={t("Reports & Analytics")} description={t("Visual insights into city performance.")} />
                ...
                <div className="grid lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="p-8 rounded-3xl bg-[#0a0a0a] border border-white/10">
                        <div className="flex justify-between items-center mb-8">
                            <h3 className="text-lg font-bold text-white flex items-center gap-2">
                                <BarChart className="text-purple-400" /> {t("Resolution Trends")}
                            </h3>
                    ...
                    <div className="p-8 rounded-3xl bg-[#0a0a0a] border border-white/10 flex flex-col justify-center">
                        <h3 className="text-lg font-bold text-white mb-8 flex items-center gap-2">
                            <PieChart className="text-blue-400" /> {t("Category Distribution")}
                        </h3>
                            ...
                            {[
                                ...
                                <div key={item.label}>
                                    <div className="flex justify-between text-sm mb-1">
                                        <span className="text-slate-300">{t(item.label)}</span>
                ...
                <div className="p-8 rounded-3xl bg-[#0a0a0a] border border-white/10">
                    <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
                        <Map className="text-rose-400" /> {t("Issue Heatmap (Density by Sector)")}
                    </h3>
                    ...
                    <div className="flex items-center gap-6 mt-6 text-xs text-slate-500 justify-end">
                        <div className="flex items-center gap-2"><div className="w-3 h-3 rounded bg-emerald-500/20" /> {t("Low")}</div>
                        <div className="flex items-center gap-2"><div className="w-3 h-3 rounded bg-yellow-500/40" /> {t("Moderate")}</div>
                        <div className="flex items-center gap-2"><div className="w-3 h-3 rounded bg-orange-500/60" /> {t("High")}</div>
                        <div className="flex items-center gap-2"><div className="w-3 h-3 rounded bg-rose-500/80" /> {t("Critical")}</div>
                    </div>
                </div>
            </main>
        </div>
